...
{
    public partial class Proba25 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Destinations_Cities_IdFrom",
                        column: x => x.IdFrom,
                        principalTable: "Cities",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Destinations_Cities_IdTo",
                        column: x => x.IdTo,
                        principalTable: "Cities",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Timetables_Destinations_IdDestination",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdTimetabe = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Prices_Destinations_DestinationId",
                        column: x => x.DestinationId,
                        principalTable: "Destinations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Prices_Timetables_TimetableId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Baskets_Prices_PriceId",
                        column: x => x.PriceId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Destinations_IdFrom",
                table: "Destinations",
                column: "IdFrom");

            migrationBuilder.CreateIndex(
                name: "IX_Destinations_IdTo",
                table: "Destinations",
                column: "IdTo");

            migrationBuilder.CreateIndex(
                name: "IX_Prices_DestinationId",
                table: "Prices",
                column: "DestinationId");

            migrationBuilder.CreateIndex(
                name: "IX_Prices_TimetableId",
                table: "Prices",
                column: "TimetableId");

            migrationBuilder.CreateIndex(
                name: "IX_Timetables_IdDestination",
                table: "Timetables",
